...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder){
        ...
        List<Livro> livros = new List<Livro> {
            ...
            new Livro { Id = 24, Nome = "Prosas seguidas de Odes Mínimas", Resumo = "Prosas seguidas de odes mínimas, de Manuel de Barros, é uma obra que reflete a singularidade da poesia do autor, marcada por uma linguagem simples e profundamente filosófica. Publicado em 1996, o livro traz um misto de prosas poéticas e breves poemas (as odes mínimas) que celebram o banal, o cotidiano e a essência das pequenas coisas. Manuel de Barros valoriza a simplicidade e a natureza, desconstruindo convenções linguísticas para criar imagens poéticas que revelam beleza no aparentemente insignificante. Ele convida o leitor a olhar o mundo com encantamento e atenção aos detalhes, promovendo uma reflexão sobre o modo como nos relacionamos com o ambiente e com as palavras.", AnaliseCritica = "Lorem Ipsum", AnaliseLiteraria = "Lorem Ipsum", Contexto = "Lorem Ipsum"},
            new Livro { Id = 25, Nome = "Vida e Morte de M.J Gonzaga de Sá", Resumo = "O livro Vida e Morte de M.J. Gonzaga de Sá, de Lima Barreto, é uma obra publicada em 1919 que aborda questões sociais, políticas e culturais do Brasil no início do século XX. A narrativa é conduzida por Augusto Machado, um jovem funcionário público, que relata a vida de seu amigo Gonzaga de Sá, um homem mais velho, também funcionário público, que reflete sobre as injustiças e contradições da sociedade brasileira.A obra critica a burocracia, o racismo e a desigualdade social, além de explorar temas como a solidão, o pessimismo e a busca por sentido em um mundo marcado por transformações urbanas e políticas. Gonzaga de Sá é retratado como um intelectual desencantado com a humanidade, enquanto Augusto tenta preservar a memória do amigo e compreender suas reflexões.", AnaliseCritica = "Lorem Ipsum", AnaliseLiteraria = "Lorem Ipsum", Contexto = "Lorem Ipsum"},
        };
        builder.Entity<Livro>().HasData(livros);

        List<LivroFoto> livroFotos = new List<LivroFoto>
        {
            new LivroFoto { Id = 1, LivroId = 1, ArquivoFoto = "/img/as meninas.jpg" },
            new LivroFoto { Id = 2, LivroId = 2, ArquivoFoto = "/img/a casa velha.jpg" },
            new LivroFoto { Id = 3, LivroId = 3, ArquivoFoto = "/img/a paixao segundo GH.jpg" },
            new LivroFoto { Id = 4, LivroId = 4, ArquivoFoto = "/img/a vida nn é util.jpg" },
            new LivroFoto { Id = 5, LivroId = 5, ArquivoFoto = "/img/a visao das plantas.jpg" },
            new LivroFoto { Id = 6, LivroId = 6, ArquivoFoto = "/img/alice no pais das maravilhas.jpg" },
            new LivroFoto { Id = 7, LivroId = 7, ArquivoFoto = "/img/balada de amor ao vento.jpg" },
            new LivroFoto { Id = 8, LivroId = 8, ArquivoFoto = "/img/caminho de pedras.jpg" },
            new LivroFoto { Id = 9, LivroId = 9, ArquivoFoto = "/img/cancao para ninar menino grande.jpg" },
            new LivroFoto { Id = 10, LivroId = 10, ArquivoFoto = "/img/CARTOLA.jpg" },
            new LivroFoto { Id = 11, LivroId = 11, ArquivoFoto = "/img/conselhos a minha filha.jpg" },
            new LivroFoto { Id = 12, LivroId = 12, ArquivoFoto = "/img/d casmurro.jpg" },
            new LivroFoto { Id = 13, LivroId = 13, ArquivoFoto = "/img/geografia.jpg" },
            new LivroFoto { Id = 14, LivroId = 14, ArquivoFoto = "/img/incidente em antares.jpg" },
            new LivroFoto { Id = 15, LivroId = 15, ArquivoFoto = "/img/joao miguel.jpg" },
            new LivroFoto { Id = 16, LivroId = 16, ArquivoFoto = "/img/memorias de marta.jpg" },
            new LivroFoto { Id = 17, LivroId = 17, ArquivoFoto = "/img/morangos mofados.jpg" },
            new LivroFoto { Id = 18, LivroId = 18, ArquivoFoto = "/img/nebulosas.jpg" },
            new LivroFoto { Id = 19, LivroId = 19, ArquivoFoto = "/img/no seu pescoço.jpg" },
            new LivroFoto { Id = 20, LivroId = 20, ArquivoFoto = "/img/nos matamos o cao tinhoso.jpg" },
            new LivroFoto { Id = 21, LivroId = 21, ArquivoFoto = "/img/o cristo cigano.jpg" },
            new LivroFoto { Id = 22, LivroId = 22, ArquivoFoto = "/img/olhos d agua.jpg" },
            new LivroFoto { Id = 23, LivroId = 23, ArquivoFoto = "/img/opusculo humanitario.jpg" },
            new LivroFoto { Id = 24, LivroId = 24, ArquivoFoto = "/img/prosas seguidas de odes minimas.jpg" },
            new LivroFoto { Id = 25, LivroId = 25, ArquivoFoto = "/img/vida e morte.jpg" },
        };
