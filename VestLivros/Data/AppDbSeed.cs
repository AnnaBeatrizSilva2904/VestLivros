...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder){
        ...
        List<Livro> livros = new List<Livro> {
            ...
            new Livro { Id = 9, Nome = "Canção para ninar menino grande", Resumo = "Canção de Ninar para Menino Grande, de Márcio Vassallo, é uma obra delicada e poética que explora o vínculo entre pais e filhos. O livro narra a história de um menino que, à medida que cresce, começa a questionar o mundo ao seu redor e os laços afetivos que moldam sua vida. Com sensibilidade, a narrativa aborda temas como amor, cuidado, amadurecimento e a importância das relações familiares. É um livro que toca profundamente o leitor, trazendo reflexões sobre o que realmente importa na jornada da vida.", AnaliseCritica = "Lorem Ipsum", Contexto = "Lorem Ipsum", ArquivoFoto = "/img/cancao para ninar menino grande.jpg"},
